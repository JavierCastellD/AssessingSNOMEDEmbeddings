...
if task == 1: # is son of
    ...
    dataset_train_2 = pd.read_csv('datasets/datasets_is_there_relation/dataset_is_there_relation_v2_dev.csv')
    dataset_train = pd.concat([dataset_train, dataset_train_2])
    dataset_dev = pd.read_csv('datasets/datasets_is_there_relation/dataset_is_there_relation_v2_test.csv')
    ...
    dataset_train_2 = pd.read_csv('datasets/datasets_semantic_type/dataset_semantic_type_dev.csv')
    dataset_train = pd.concat([dataset_train, dataset_train_2])
    dataset_dev = pd.read_csv('datasets/datasets_semantic_type/dataset_semantic_type_test.csv')
    ...
    dataset_train_2 = pd.read_csv('datasets/datasets_top_level_hierarchy/dataset_top_level_hierarchy_dev.csv')
    dataset_train = pd.concat([dataset_train, dataset_train_2])
    dataset_dev = pd.read_csv('datasets/datasets_top_level_hierarchy/dataset_top_level_hierarchy_test.csv')
    ...
    dataset_train_2 = pd.read_csv('datasets/datasets_triple_classification/dataset_triple_classification_v2_dev.csv')
    dataset_train = pd.concat([dataset_train, dataset_train_2])
    dataset_dev = pd.read_csv('datasets/datasets_triple_classification/dataset_triple_classification_v2_test.csv')
...
with open(log_output_file_name, 'a') as log_output:
    ...
    nn = EmbeddingClassifier(number_of_classes, n_embeddings, batch_size, epochs, dense_layers,
                            ...
                            l2_regularization, optimizer_function, learning_rate, embedding_size=embedding_size)
